...
\begin{figure*}[!b]
    ...
    \begin{subfigure}[t]{0.3\linewidth}
	    ...
	    \caption{Sample of the negative resist pattern with $\tau = 0.5$~min. Taking into account that a negative tone was used, it can be seen that the sample was clearly overexposed.}
	    \label{fig:b2d1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.3\linewidth}
	    ...
	    \caption{Sample of the negative resist pattern with $\tau = 0.2$~min. Note that the sample is underexposed.}
	    \label{fig:b2h1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.3\linewidth}
	    ...
	    \caption{Sample of the negative resist pattern with $\tau = 0.3$~min. The sample is again underexposed, but not as much as the sample with an exposure time of 0.2 minutes.}
	    \label{fig:b2i1}
    \end{subfigure}
...
% ================== Checked up to here ===============
Images of the checkerboard patterns on the positive tone sample with an exposure time of 2 minutes were taken with a Hitachi S4800 scanning electron microscope. On the largest checkerboard (figure \ref{fig:b2d5_q5}) the exposure time appears These are shown in figures \ref{fig:b2d5_q5}-\subref{fig:b2d10_q11}.
