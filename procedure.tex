...
\begin{figure*}[!b]
    ...
    \begin{subfigure}[t]{0.3\linewidth}
        ...
        \caption{Two minute exposure. The checkerboard pattern in the lower-right corner is of the same size as the one in figure \ref{fig:b3d1}.\todo[inline]{klopt de label?}}
        \label{fig:b3a1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.3\linewidth}
