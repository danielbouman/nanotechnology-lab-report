...
\begin{figure*}[!b]
    ...
    \begin{subfigure}[t]{0.3\linewidth}
        ...
        \caption{$\tau = 2$~min. The checkerboard pattern in the lower-right corner is of the same size as the one in sub figure \subref{fig:b3d1}.}
        \label{fig:b3a1}
    \end{subfigure}
