...
The basic working of a contact lithography systems is illustrated in figure \ref{fig:contact-litho}. Light emitted from a source is collimated using a lens (usually this is an array of lenses), 
\begin{figure}[H]
	\centering
...
\end{figure} In this report contact lithography was used.
